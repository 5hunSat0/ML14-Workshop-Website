...
var schedule_normal = scheduletext.innerHTML;
...
btn.addEventListener("change", () => {
  if (btn.checked == true) {
    ...
    var dark2 = document.getElementById("dark2");
		dark2.innerHTML="<h4>時田 椋子<br>地域医療としてのアディクション治療の実際</h4><p>入院ではない依存症の治療ーー万人が諦めたその先に光はあるのか。伊、バザーリアが追い求めた理想とは…？地域医療としての役割、そしてその闇とは…。闇とともに立ち上がる治療者と経営者、それでも縋りたい患者たちとの狭間で揺れ動く心理職としての存在に正解はあるのか……。<br>大学院では習えない？！理想と現実、司法と医療のスペクタクルデイナイトケア！！いま、あなたの倫理が試される…！！<br></p>";
    ...
    var scheduleext = document.getElementById("schedule");
    scheduletext.innerHTML=schedule_normal;
    var toptext = document.getElementById("toptext");
